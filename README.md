...
```bash
git clone https://github.com/Emotionvonsignify/SearchCLI-989.git
cd SearchCLI-989
npm install
npm start
```
...
English | [简体中文](README.zh_CN.md) | [日本語](README.ja_JP.md) | [Deutsch](README.de_DE.md)
...
<!-- Last updated: 2026-06-06 14:54:16 -->
